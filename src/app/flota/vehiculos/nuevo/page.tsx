...
export default function NuevoVehiculoPage() {
  ...
  const [form, setForm] = useState({
    ...
    kmActual: "", vencimientoSOAP: "", vencimientoRevTecnica: "",
    vencimientoPermiso: "", observaciones: "",
  })
          ...
          <div className="border-t pt-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  type="date"
                  value={form.vencimientoSOAP}
                  onChange={(e) => set("vencimientoSOAP", e.target.value)}
                  className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300"
                />
              </div>
              <div>
                ...
                <input
                  type="date"
                  value={form.vencimientoRevTecnica}
                  onChange={(e) => set("vencimientoRevTecnica", e.target.value)}
                  className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300"
                />
              </div>
              <div>
                ...
                <input
                  type="date"
                  value={form.vencimientoPermiso}
                  onChange={(e) => set("vencimientoPermiso", e.target.value)}
                  className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300"
                />
              </div>
            </div>
